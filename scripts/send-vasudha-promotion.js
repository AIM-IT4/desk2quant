    ...
    return `
        <div style="background:#ffffff; border-radius:12px; overflow:hidden; margin-bottom:24px; box-shadow:0 4px 15px rgba(0,0,0,0.05); border:1px solid #eef2f6; transition: transform 0.2s ease;">
            ...
            <div style="padding:20px;">
                ...
                <a href="https://desk2quant.com/product.html?id=${rec.id}" style="display:block; text-align:center; background:#4f46e5; color:#ffffff; font-weight:700; text-decoration:none; padding:12px 20px; border-radius:8px; font-size:14px;">Apply Code & View →</a>
            </div>
        </div>
    `;
}).join('');
...
1. Quant Models for Each Asset Class
   ...
   - View: https://desk2quant.com/product.html?id=75f6118b-c10e-43c6-acc6-ec48cd6a6cbc

2. Derivatives Products & Pricing
   - Original Price: ₹1999 -> Your Price: ₹1399
   - View: https://desk2quant.com/product.html?id=bdb3c59e-c8c0-430f-8705-b7467514458e

3. Ultimate Industry Grade Quant Projects
   - Original Price: ₹799 -> Your Price: ₹559
   - View: https://desk2quant.com/product.html?id=bd2e57b7-32c4-44ad-8a2a-d156222b7ff7

4. Quant Interview Problem Book
   - Original Price: ₹899 -> Your Price: ₹629
   - View: https://desk2quant.com/product.html?id=73806d69-768b-497e-87b7-d94fa4cfd772
