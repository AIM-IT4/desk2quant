...
async function notifyMentorBooking(b){
    ...
    const hostBody=confirmed
        ? `${details}<p><a href="${escapeHtml(hostUrl)}">Start as host</a></p><p>Open this host link first. Learners remain in the Desk2Quant waiting room until you open this host link.</p>`
        : customerBody;
